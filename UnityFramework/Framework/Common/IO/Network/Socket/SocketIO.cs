...
namespace Framework.Common.IO.Network.Socket
{
    ...
    public class SocketIO
    {
        ...
        private bool Exception(Exception e)
        {
        ...
        {
            if (e != null && e.BytesTransferred != 0) return false;
            Disconnect(true);
            return true;
        }
        ...
        {
            if (SocketEventArgsList.Contains(e))
